...
public class last10BusAvgRating extends Configured implements Tool {
	...
	public static class Reduce extends Reducer<Text,FloatWritable,Text,FloatWritable> {
		...
		protected void cleanup(Context context) throws IOException, InterruptedException {
			HashMap<String, Float> sortedRatings = (HashMap<String, Float>) SortBottomTenFloat.sortByValues(sortRatings);
			int i = 1;
	...
	public int run(String[] args) throws Exception {
		...
		if (args.length != 2) {
			System.err.println("Usage: last10BusAvgRating <ip file> <out file>");
			System.exit(2);
		}
		...
		job.setJobName("Last 10 Businesses with Average Ratings");

		job.setJarByClass(last10BusAvgRating.class);
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new Configuration(), new last10BusAvgRating(), args);
